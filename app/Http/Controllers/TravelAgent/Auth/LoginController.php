...
use AuthenticatesUsers;
    ...
    {
        $this->middleware('travel_agent.guest')->except('logout');
    }
    ...
    {
        return view('travel_agent.auth.login');
    }
    ...
    {
        $this->guard('travel_agent')->logout();
    ...
    public function handleProviderCallback($provider)
    {
        ...
        Auth::guard('travel_agent')->login($authUser, true);
    ...
    {
        if ($user->getEmail() != '') {
            $authUser = TravelAgent::where('email', 'like', $user->getEmail())->first();
            if ($authUser) {
