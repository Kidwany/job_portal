                ...
                <div class="userccount">
                    ...
                    <div class="tab-content">
                        <div id="candidate" class="formpanel tab-pane {{($c_or_e == 'candidate')? 'active':''}}">
                            ...
                            <form class="form-horizontal" method="POST" action="{{ url('travel-agent/login') }}">
                                {{ csrf_field() }}
                            ...
                            <!-- sign up form -->
                            <div class="newuser"><i class="fa fa-user" aria-hidden="true"></i> {{__('New Company')}}? <a href="{{url('travel-agent/register')}}">{{__('Register Here')}}</a></div>
