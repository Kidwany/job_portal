    ...
    <div class="container">
        ...
        <ul class="howlist row">
            ...
            <li class="col-lg-3 col-md-6 col-sm-12">
                <div class="h-i-w-content-box">
                    <div class="iconcircle">
                        <img src="{{asset('/')}}images/Works/h-i-w-1.png" alt="" />
                        </i>
                    </div>
            ...
            <li class="col-lg-3 col-md-6 col-sm-12">
                <div class="h-i-w-content-box">
                    <div class="iconcircle">
                        <img src="{{asset('/')}}images/Works/h-i-w-2.png" alt="" />
                        </i>
                    </div>
            ...
            <li class="col-lg-3 col-md-6 col-sm-12">
                <div class="h-i-w-content-box">
                    <div class="iconcircle">
                        <img src="{{asset('/')}}images/Works/h-i-w-3.png" alt="" />
                        </i>
                    </div>
            ...
            <li class="col-lg-3 col-md-6 col-sm-12">
                <div class="h-i-w-content-box">
                    <div class="iconcircle">
                        <img src="{{asset('/')}}images/Works/h-i-w-4.png" alt="" />
                        </i>
                    </div>
