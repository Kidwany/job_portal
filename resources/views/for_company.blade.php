...
@include('includes.inner_page_title', ['page_title'=>__('For Company')])
		...
		<div class="container mt-5">
			<div class="row my-4 py-4 text-center">
				<div class="col-md-4 col-sm-12">
					...
					<h5 class="my-4">{{__('Small Business Solutions')}}</h5>
					<a class="btn btn-amber" href="{{url('offers-lite')}}">{{__('Explore Now')}}
						</a>
				</div>
				<div class="col-md-4 col-sm-12">
					<i class="icon is-briefcase"></i>
					<h5 class="my-4">{{__('Post Your Job')}}</h5>
					<a class="btn btn-amber" href="#">{{__('Post Now')}} </a>
						
				</div>
				<div class="col-md-4 col-sm-12">
					<i class="icon is-gift"></i>
					<h5 class="my-4">{{__('Get Your Special Offer')}}</h5>
					<a class="btn btn-amber" href="{{url('company-offers')}}">{{__('Save Now')}}
						 </a>
				</div>
			</div>
		</div>
	...
	<section class="text-center p-4">
		<div class="container">
			<div class="section-title text-center mb-4 pb-2">
				<h3 class="title title-line pb-5">{{__('Select Your Recruitment Plan')}}</h3>
			</div>
