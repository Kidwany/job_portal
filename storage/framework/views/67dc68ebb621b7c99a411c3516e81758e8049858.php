            ...
            <div class="swiper-wrapper">
                ...
                <div class="swiper-slide">
                    <div
                            class="slider-img"
                            style="
                            background-image: url('<?php echo e(asset('website/images/home-main-slides/slide-1.webp')); ?>');
                        "
                    ></div>
                </div>
                ...
                <div class="swiper-slide">
                    <div
                            class="slider-img"
                            style="background-image: url('<?php echo e(asset('website/images/home-main-slides/slide-1.webp')); ?>');"
                    ></div>
                </div>
                <div class="swiper-slide">
                    <div
                            class="slider-img"
                            style="background-image: url('<?php echo e(asset('website/images/home-main-slides/slide-2.webp')); ?>');"
                    ></div>
                </div>
                <div class="swiper-slide">
                    <div
                            class="slider-img"
                            style="background-image: url('.<?php echo e(asset('website/mages/home-main-slides/slide-3.webp')); ?>');"
                    ></div>
                </div>
                ...
                <form action="<?php echo e(route('job.list')); ?>" method="get">
                    <div class="input-group-btn">
                        ...
                        <div class="input-btn-group">
                            <input type="text" placeholder="Enter skils or job title" name="search" value="<?php echo e(Request::get('search', '')); ?>"/>
                            <button type="submit">
										<span>
											Search
										</span>
    ...
    <div class="mfa-container">
        <ul class="section-ul">
            <li data-aos="zoom-in" data-aos-duration="500" data-aos-delay="0">
                <div class="img-div">
                    <img src="<?php echo e(asset('website/images/counter/hire.svg')); ?>" alt="img" />
                </div>
            ...
            <li data-aos="zoom-in" data-aos-duration="500" data-aos-delay="200">
                <div class="img-div">
                    <img src="<?php echo e(asset('website/images/counter/portfolio.svg')); ?>" alt="img" />
                </div>
                <div class="counter-text">
                    <p class="number">
                        187,432
            ...
            <li data-aos="zoom-in" data-aos-duration="500" data-aos-delay="400">
                <div class="img-div">
                    <img src="<?php echo e(asset('website/images/counter/interview.svg')); ?>" alt="img" />
                </div>
                <div class="counter-text">
                    <p class="number">
                        140,312
...
<div class="how-it-works-section">
    <div class="mfa-container">
        <div class="section-heading">
            <h2>
                <img src="<?php echo e(asset('website/images/how-it-works/procedure.svg')); ?>" alt="img" />
                How it works
            </h2>
        </div>
        ...
        <div class="section-body">
            <ul class="main-ul">
                <li>
                    <img src="<?php echo e(asset('website/images/how-it-works/h-i-w-1.png')); ?>"
                            alt="create account"
                    />
                    <div class="li-title">
                        Create an account
                ...
                <li>
                    <img src="<?php echo e(asset('website/images/how-it-works/h-i-w-2.png')); ?>" alt="img" />
                    <div class="li-title">
                        Update Profile
                    </div>
                    <div class="li-body">
                ...
                <li>
                    <img src="<?php echo e(asset('website/images/how-it-works/h-i-w-3.png')); ?>" alt="img" />
                    <div class="li-title">
                        Search Desired Job
                    </div>
                    <div class="li-body">
                ...
                <li>
                    <img src="<?php echo e(asset('website/images/how-it-works/h-i-w-4.png')); ?>" alt="img" />
                    <div class="li-title">
                        Send your Resume
                    </div>
                    <div class="li-body">
...
<div class="featured-jobs-section">
    <div class="mfa-container">
        <div class="section-wrapper">
            <div class="section-heading">
                <h2>
                    <img src="<?php echo e(asset('website/images/icons/featured.svg')); ?>" alt="Best jobs" />
                ...
                <ul class="main-section-ul">
                    <?php if(isset($featuredJobs) && count($featuredJobs)): ?>
                        <?php $__currentLoopData = $featuredJobs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $featuredJob): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <?php if(null !== $company): ?>
                                <li>
                                        <a href="<?php echo e(route('job.detail', [$featuredJob->slug])); ?>">
                                            <div class="img-div">
                                                <img src="<?php echo asset('company_logos/' . $company->logo); ?>" alt="job image" />
                                            </div>
                                            <div class="job-desc">
                                                <div class="job-title-date">
                                                    ...
                                                    <div class="date">
                                                        ...
                                                        <?php echo e($featuredJob->created_at->diffForHumans()); ?>
                                                ...
                                                <div class="location-option">
                                                    <div class="location">
                                                        ...
                                                        Egypt - <?php echo e($featuredJob->getCity('city')); ?>
            ...
            <a href="<?php echo e(url('jobs')); ?>" class="all-jobs">
                View all jobs
            </a>
        </div>
    </div>
    ...
    <div class="section-body">
        <ul class="main-section-ul">
            <li>
                <a class="service-card" href="/">
                    <div class="service-img">
                        <img src="<?php echo e(asset('website/images/services/1.png')); ?>" alt="img" />
                    </div>
            ...
            <li>
                <a class="service-card" href="#">
                    <div class="service-img">
                        <img src="<?php echo e(asset('website/images/services/2.png')); ?>" alt="img" />
                    </div>
                    <div class="service-text">
                        <p class="service-title">
            ...
            <li>
                <a class="service-card" href="#">
                    <div class="service-img">
                        <img src="<?php echo e(asset('website/images/services/3.png')); ?>" alt="img" />
                    </div>
                    <div class="service-text">
                        <p class="service-title">
                            Youth Support
            ...
            <li>
                <a class="service-card" href="#">
                    <div class="service-img">
                        <img src="<?php echo e(asset('website/images/services/4.png')); ?>" alt="img" />
                    </div>
                    <div class="service-text">
                        <p class="service-title">
                            Startups Funding
            ...
            <li>
                <a class="service-card" href="#">
                    <div class="service-img">
                        <img src="<?php echo e(asset('website/images/services/5.png')); ?>" alt="img" />
                    </div>
                    <div class="service-text">
                        <p class="service-title">
                            Remote Working
            ...
            <li>
                <a class="service-card" href="#">
                    <div class="service-img">
                        <img src="<?php echo e(asset('website/images/services/6.png')); ?>" alt="img" />
                    </div>
                    <div class="service-text">
                        <p class="service-title">
                            Exams
...
<div class="startups-section">
    <div class="mfa-container">
        <div class="startups-wrapper">
            ...
            >
                <h2>
                    <img src="<?php echo e(asset('website/images/icons/rocket.svg')); ?>" alt="speed up" />
                    Empowering Startups
                </h2>
            ...
            <img
                    ...
                    data-aos-duration="600"
                    data-aos-delay="300"
                    src="<?php echo e(asset('website/images/startups/hero-fist-bump.svg')); ?>"
                    alt="startups"
            />
        </div>
    </div>
    ...
    <div class="mfa-container">
        <div class="section-wrapper">
            <img
                    ...
                    data-aos-duration="600"
                    data-aos-delay="50"
                    src="<?php echo e(asset('website/images/looking-job/callto.png')); ?>"
    ...
    <div class="mfa-container">
        <div class="section-wrapper">
            <div class="egypt-section">
                ...
                <img src="<?php echo e(asset('website/images/egypt-2030/egypt-2030.png')); ?>" alt="egypt 2030" />
                <p>
            ...
            <div class="million-section">
                ...
                <img src="<?php echo e(asset('website/images/egypt-2030/million.png')); ?>" alt="egypt 2030" />
                    ...
                    <?php $__currentLoopData = $blogs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $blog): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        ?>
                            <li>
                                ...
                                ?>
                                <a href="<?php echo e(url('blog/' . $blog->slug)); ?>" class="blog-card">
                                    <div class="img-div lazy-div">
                                        <?php if(null!==($blog->image) && $blog->image!=""): ?>
                                            <img class="lazy" data-src="<?php echo e(asset('uploads/blogs/'.$blog->image)); ?>" alt="<?php echo e($blog->heading); ?>" />
                                        <?php else: ?>
                    ...
                    <div class="swiper-wrapper">
                        <?php if(isset($testimonials) && count($testimonials)): ?>
                            <?php $__currentLoopData = $testimonials; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $testimonial): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="swiper-slide">
                                    <div class="img-div">
                                        <img src="<?php echo e(asset('website/images/testimonials/1.jpg')); ?>" alt="img" />
                                    </div>
                                    ...
                                    <div class="content">
                                        ...
                                        <div class="name">
                                            <?php echo e($testimonial->testimonial_by); ?>
...
<div class="subscribe-section">
    <div class="mfa-container">
        ...
        <div class="section-body">
            ...
            <form action="<?php echo e(route('subscribe.newsletter')); ?>" class="subscribe-form" method="post">
