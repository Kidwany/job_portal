            ...
            <div class="mfa-container">
                <div class="certificate-section">
                    <div class="section-heading">
                        <h1>
                            <img src="<?php echo e(asset('website/images/certificates/medal.svg')); ?>" alt="img" />
                            Certificate Translate and Registration
                        </h1>
                        <p>
                ...
                <div class="registeration-section">
                    <div class="section-heading">
                        <h1>
                            <img src="<?php echo e(asset('website/images/certificates/email.svg')); ?>" alt="img" />
                            Contact Us
                        </h1>
                    </div>
                    ...
                    <div class="sectionBody">
                        ...
                        <form class="mfa-form" action="<?php echo e(url('certificate/store')); ?>" method="post" enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
                            <div class="form-div">
                                <label for="name">
										<span>
                            ...
                            <div class="form-div">
                                <label for="email">
                                    ...
                                    <input type="text" id="email" required name="email" value="<?php echo e(old('email')); ?>"/>
                            ...
                            <div class="form-div">
                                <label for="phone">
                                    ...
                                    <input type="tel" id="phone" required name="phone" value="<?php echo e(old('phone')); ?>"/>
