                ...
                <div class="portlet light bordered">
                    ...
                    <div class="portlet-body form">          
                        ...
                        <div class="tab-content">              
                            ...
                            <div class="tab-pane fade" id="homePageSlider"> <?php echo $__env->make('admin.site_setting.forms.homePageSliderSetting_form', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?> </div>
                            <div class="tab-pane fade" id="mailChimp"> <?php echo $__env->make('admin.site_setting.forms.mailChimpSetting_form', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?> </div>
                        </div>
